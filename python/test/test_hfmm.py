...
def test_hfmm():
    ...
    itest = itest + 1
    out = fmm.hfmm3d(
        eps=eps, zk=zk, sources=sources, charges=charges, dipvec=dipvec, pg=1
    )
    out2 = fmm.h3ddir(
        zk=zk, sources=sources, targets=stmp, charges=charges, dipvec=dipvec, pgt=1
    )
    out2.pot = out2.pottarg
    err = fmm.comperr(ntest=ntest, out=out, outex=out2, pg=1)
    ...
    out2 = fmm.h3ddir(zk=zk, sources=sources, targets=stmp, charges=charges, pgt=2)
    out2.pot = out2.pottarg
    ...
    out2 = fmm.h3ddir(zk=zk, sources=sources, targets=stmp, dipvec=dipvec, pgt=2)
    out2.pot = out2.pottarg
    out2.grad = out2.gradtarg
    err = fmm.comperr(ntest=ntest, out=out, outex=out2, pg=2)
    ...
    itest = itest + 1
    out = fmm.hfmm3d(
        eps=eps, zk=zk, sources=sources, charges=charges, dipvec=dipvec, pg=2
    )
    out2 = fmm.h3ddir(
        zk=zk, sources=sources, targets=stmp, charges=charges, dipvec=dipvec, pgt=2
    )
    out2.pot = out2.pottarg
    out2.grad = out2.gradtarg
    err = fmm.comperr(ntest=ntest, out=out, outex=out2, pg=2)
    ...
    itest = itest + 1
    out = fmm.hfmm3d(
        eps=eps, zk=zk, sources=sources, targets=targ, charges=charges, pgt=1
    )
    ...
    out = fmm.hfmm3d(
        eps=eps, zk=zk, sources=sources, targets=targ, dipvec=dipvec, pgt=1
    )

    out2 = fmm.h3ddir(zk=zk, sources=sources, targets=ttmp, dipvec=dipvec, pgt=1)
    err = fmm.comperr(ntest=ntest, out=out, outex=out2, pgt=1)
    ...
    out2 = fmm.h3ddir(
        zk=zk, sources=sources, targets=ttmp, charges=charges, dipvec=dipvec, pgt=1
    )
    err = fmm.comperr(ntest=ntest, out=out, outex=out2, pgt=1)
    ...
    itest = itest + 1
    out = fmm.hfmm3d(
        eps=eps, zk=zk, sources=sources, targets=targ, charges=charges, pgt=2
    )
    ...
    out = fmm.hfmm3d(
        eps=eps, zk=zk, sources=sources, targets=targ, dipvec=dipvec, pgt=2
    )
    out2 = fmm.h3ddir(zk=zk, sources=sources, targets=ttmp, dipvec=dipvec, pgt=2)
    err = fmm.comperr(ntest=ntest, out=out, outex=out2, pgt=2)
    ...
    out2 = fmm.h3ddir(
        zk=zk, sources=sources, targets=ttmp, charges=charges, dipvec=dipvec, pgt=2
    )
    err = fmm.comperr(ntest=ntest, out=out, outex=out2, pgt=2)
    ...
    itest = itest + 1
    out = fmm.hfmm3d(
        eps=eps, zk=zk, sources=sources, targets=targ, charges=charges, pgt=1, pg=1
    )
    out2 = fmm.h3ddir(zk=zk, sources=sources, targets=stmp, charges=charges, pgt=1)
    ...
    out = fmm.hfmm3d(
        eps=eps, zk=zk, sources=sources, targets=targ, dipvec=dipvec, pgt=1, pg=1
    )
    out2 = fmm.h3ddir(zk=zk, sources=sources, targets=stmp, dipvec=dipvec, pgt=1)
    outex.pot = out2.pottarg
    outex.grad = out2.gradtarg
    ...
    itest = itest + 1
    out = fmm.hfmm3d(
        eps=eps, zk=zk, sources=sources, targets=targ, charges=charges, pgt=2, pg=2
    )
    out2 = fmm.h3ddir(zk=zk, sources=sources, targets=stmp, charges=charges, pgt=2)
    outex.pot = out2.pottarg
    outex.grad = out2.gradtarg
    ...
    out = fmm.hfmm3d(
        eps=eps, zk=zk, sources=sources, targets=targ, dipvec=dipvec, pgt=2, pg=2
    )
    out2 = fmm.h3ddir(zk=zk, sources=sources, targets=stmp, dipvec=dipvec, pgt=2)
    outex.pot = out2.pottarg
    outex.grad = out2.gradtarg
    ...
    dipvec = np.random.uniform(0, 1, (nd, 3, n)) + 1j * np.random.uniform(
        0, 1, (nd, 3, n)
    )
    ...
    out2 = fmm.h3ddir(
        zk=zk, sources=sources, targets=stmp, charges=charges, pgt=1, nd=nd
    )
    out2.pot = out2.pottarg
    ...
    itest = itest + 1
    out = fmm.hfmm3d(
        eps=eps, zk=zk, sources=sources, charges=charges, dipvec=dipvec, pg=1, nd=nd
    )
    out2 = fmm.h3ddir(
        zk=zk,
        sources=sources,
    ...
    out2 = fmm.h3ddir(
        zk=zk, sources=sources, targets=stmp, charges=charges, pgt=2, nd=nd
    )
    out2.pot = out2.pottarg
    out2.grad = out2.gradtarg
    ...
    out2 = fmm.h3ddir(zk=zk, sources=sources, targets=stmp, dipvec=dipvec, pgt=2, nd=nd)
    out2.pot = out2.pottarg
    out2.grad = out2.gradtarg
    err = fmm.comperr(ntest=ntest, out=out, outex=out2, pg=2, nd=nd)
    ...
    itest = itest + 1
    out = fmm.hfmm3d(
        eps=eps, zk=zk, sources=sources, charges=charges, dipvec=dipvec, pg=2, nd=nd
    )
    out2 = fmm.h3ddir(
        zk=zk,
        sources=sources,
    ...
    itest = itest + 1
    out = fmm.hfmm3d(
        eps=eps, zk=zk, sources=sources, targets=targ, charges=charges, pgt=1, nd=nd
    )
    out2 = fmm.h3ddir(
        zk=zk, sources=sources, targets=ttmp, charges=charges, pgt=1, nd=nd
    )
    ...
    out = fmm.hfmm3d(
        eps=eps, zk=zk, sources=sources, targets=targ, dipvec=dipvec, pgt=1, nd=nd
    )

    out2 = fmm.h3ddir(zk=zk, sources=sources, targets=ttmp, dipvec=dipvec, pgt=1, nd=nd)
    err = fmm.comperr(ntest=ntest, out=out, outex=out2, pgt=1, nd=nd)
    ...
    itest = itest + 1
    out = fmm.hfmm3d(
        eps=eps, zk=zk, sources=sources, targets=targ, charges=charges, pgt=2, nd=nd
    )
    out2 = fmm.h3ddir(
        zk=zk, sources=sources, targets=ttmp, charges=charges, pgt=2, nd=nd
    )
    ...
    out = fmm.hfmm3d(
        eps=eps, zk=zk, sources=sources, targets=targ, dipvec=dipvec, pgt=2, nd=nd
    )
    out2 = fmm.h3ddir(zk=zk, sources=sources, targets=ttmp, dipvec=dipvec, pgt=2, nd=nd)
    err = fmm.comperr(ntest=ntest, out=out, outex=out2, pgt=2, nd=nd)
    ...
    out = fmm.hfmm3d(
        eps=eps, zk=zk, sources=sources, targets=targ, dipvec=dipvec, pgt=1, pg=1, nd=nd
    )
    out2 = fmm.h3ddir(zk=zk, sources=sources, targets=stmp, dipvec=dipvec, pgt=1, nd=nd)
    outex.pot = out2.pottarg
    outex.grad = out2.gradtarg
    ...
    out = fmm.hfmm3d(
        eps=eps, zk=zk, sources=sources, targets=targ, dipvec=dipvec, pgt=2, pg=2, nd=nd
    )
    out2 = fmm.h3ddir(zk=zk, sources=sources, targets=stmp, dipvec=dipvec, pgt=2, nd=nd)
    outex.pot = out2.pottarg
    outex.grad = out2.gradtarg
