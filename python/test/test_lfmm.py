...
def test_lfmm():
    ...
    itest = itest + 1
    out = fmm.lfmm3d(eps=eps, sources=sources, charges=charges, dipvec=dipvec, pg=1)
    out2 = fmm.l3ddir(
        sources=sources, targets=stmp, charges=charges, dipvec=dipvec, pgt=1
    )
    out2.pot = out2.pottarg
    err = fmm.comperr(ntest=ntest, out=out, outex=out2, pg=1)
    ...
    out2 = fmm.l3ddir(sources=sources, targets=stmp, charges=charges, pgt=2)
    out2.pot = out2.pottarg
    ...
    out2 = fmm.l3ddir(sources=sources, targets=stmp, dipvec=dipvec, pgt=2)
    out2.pot = out2.pottarg
    out2.grad = out2.gradtarg
    err = fmm.comperr(ntest=ntest, out=out, outex=out2, pg=2)
    ...
    itest = itest + 1
    out = fmm.lfmm3d(eps=eps, sources=sources, charges=charges, dipvec=dipvec, pg=2)
    out2 = fmm.l3ddir(
        sources=sources, targets=stmp, charges=charges, dipvec=dipvec, pgt=2
    )
    out2.pot = out2.pottarg
    out2.grad = out2.gradtarg
    err = fmm.comperr(ntest=ntest, out=out, outex=out2, pg=2)
    ...
    out2 = fmm.l3ddir(sources=sources, targets=stmp, charges=charges, pgt=3)
    out2.pot = out2.pottarg
    out2.grad = out2.gradtarg
    ...
    out2 = fmm.l3ddir(sources=sources, targets=stmp, dipvec=dipvec, pgt=3)
    out2.pot = out2.pottarg
    out2.grad = out2.gradtarg
    out2.hess = out2.hesstarg
    err = fmm.comperr(ntest=ntest, out=out, outex=out2, pg=3)
    ...
    itest = itest + 1
    out = fmm.lfmm3d(eps=eps, sources=sources, charges=charges, dipvec=dipvec, pg=3)
    out2 = fmm.l3ddir(
        sources=sources, targets=stmp, charges=charges, dipvec=dipvec, pgt=3
    )
    out2.pot = out2.pottarg
    out2.grad = out2.gradtarg
    out2.hess = out2.hesstarg
    ...
    out = fmm.lfmm3d(eps=eps, sources=sources, targets=targ, dipvec=dipvec, pgt=1)

    out2 = fmm.l3ddir(sources=sources, targets=ttmp, dipvec=dipvec, pgt=1)
    err = fmm.comperr(ntest=ntest, out=out, outex=out2, pgt=1)
    ...
    itest = itest + 1
    out = fmm.lfmm3d(
        eps=eps, sources=sources, targets=targ, charges=charges, dipvec=dipvec, pgt=1
    )

    out2 = fmm.l3ddir(
        sources=sources, targets=ttmp, charges=charges, dipvec=dipvec, pgt=1
    )
    err = fmm.comperr(ntest=ntest, out=out, outex=out2, pgt=1)
    ...
    out = fmm.lfmm3d(eps=eps, sources=sources, targets=targ, dipvec=dipvec, pgt=2)
    out2 = fmm.l3ddir(sources=sources, targets=ttmp, dipvec=dipvec, pgt=2)
    err = fmm.comperr(ntest=ntest, out=out, outex=out2, pgt=2)
    ...
    itest = itest + 1
    out = fmm.lfmm3d(
        eps=eps, sources=sources, targets=targ, charges=charges, dipvec=dipvec, pgt=2
    )
    out2 = fmm.l3ddir(
        sources=sources, targets=ttmp, charges=charges, dipvec=dipvec, pgt=2
    )
    err = fmm.comperr(ntest=ntest, out=out, outex=out2, pgt=2)
    ...
    out = fmm.lfmm3d(eps=eps, sources=sources, targets=targ, dipvec=dipvec, pgt=3)
    out2 = fmm.l3ddir(sources=sources, targets=ttmp, dipvec=dipvec, pgt=3)
    err = fmm.comperr(ntest=ntest, out=out, outex=out2, pgt=3)
    ...
    itest = itest + 1
    out = fmm.lfmm3d(
        eps=eps, sources=sources, targets=targ, charges=charges, dipvec=dipvec, pgt=3
    )
    out2 = fmm.l3ddir(
        sources=sources, targets=ttmp, charges=charges, dipvec=dipvec, pgt=3
    )
    err = fmm.comperr(ntest=ntest, out=out, outex=out2, pgt=3)
    ...
    itest = itest + 1
    out = fmm.lfmm3d(
        eps=eps, sources=sources, targets=targ, charges=charges, pgt=1, pg=1
    )
    out2 = fmm.l3ddir(sources=sources, targets=stmp, charges=charges, pgt=1)
    ...
    out = fmm.lfmm3d(eps=eps, sources=sources, targets=targ, dipvec=dipvec, pgt=1, pg=1)
    out2 = fmm.l3ddir(sources=sources, targets=stmp, dipvec=dipvec, pgt=1)
    outex.pot = out2.pottarg
    outex.grad = out2.gradtarg
    out2 = fmm.l3ddir(sources=sources, targets=ttmp, dipvec=dipvec, pgt=1)
    ...
    itest = itest + 1
    out = fmm.lfmm3d(
        eps=eps, sources=sources, targets=targ, charges=charges, pgt=2, pg=2
    )
    out2 = fmm.l3ddir(sources=sources, targets=stmp, charges=charges, pgt=2)
    outex.pot = out2.pottarg
    outex.grad = out2.gradtarg
    ...
    out = fmm.lfmm3d(eps=eps, sources=sources, targets=targ, dipvec=dipvec, pgt=2, pg=2)
    out2 = fmm.l3ddir(sources=sources, targets=stmp, dipvec=dipvec, pgt=2)
    outex.pot = out2.pottarg
    outex.grad = out2.gradtarg
    out2 = fmm.l3ddir(sources=sources, targets=ttmp, dipvec=dipvec, pgt=2)
    ...
    itest = itest + 1
    out = fmm.lfmm3d(
        eps=eps, sources=sources, targets=targ, charges=charges, pgt=3, pg=3
    )
    out2 = fmm.l3ddir(sources=sources, targets=stmp, charges=charges, pgt=3)
    outex.pot = out2.pottarg
    outex.grad = out2.gradtarg
    ...
    out = fmm.lfmm3d(eps=eps, sources=sources, targets=targ, dipvec=dipvec, pgt=3, pg=3)
    out2 = fmm.l3ddir(sources=sources, targets=stmp, dipvec=dipvec, pgt=3)
    outex.pot = out2.pottarg
    outex.grad = out2.gradtarg
    outex.hess = out2.hesstarg
    ...
    itest = itest + 1
    out = fmm.lfmm3d(
        eps=eps, sources=sources, charges=charges, dipvec=dipvec, pg=1, nd=nd
    )
    out2 = fmm.l3ddir(
        sources=sources, targets=stmp, charges=charges, dipvec=dipvec, pgt=1, nd=nd
    )
    out2.pot = out2.pottarg
    err = fmm.comperr(ntest=ntest, out=out, outex=out2, pg=1, nd=nd)
    ...
    out2 = fmm.l3ddir(sources=sources, targets=stmp, charges=charges, pgt=2, nd=nd)
    out2.pot = out2.pottarg
    out2.grad = out2.gradtarg
    ...
    out2 = fmm.l3ddir(sources=sources, targets=stmp, dipvec=dipvec, pgt=2, nd=nd)
    out2.pot = out2.pottarg
    out2.grad = out2.gradtarg
    err = fmm.comperr(ntest=ntest, out=out, outex=out2, pg=2, nd=nd)
    ...
    itest = itest + 1
    out = fmm.lfmm3d(
        eps=eps, sources=sources, charges=charges, dipvec=dipvec, pg=2, nd=nd
    )
    out2 = fmm.l3ddir(
        sources=sources, targets=stmp, charges=charges, dipvec=dipvec, pgt=2, nd=nd
    )
    out2.pot = out2.pottarg
    out2.grad = out2.gradtarg
    err = fmm.comperr(ntest=ntest, out=out, outex=out2, pg=2, nd=nd)
    ...
    out2 = fmm.l3ddir(sources=sources, targets=stmp, charges=charges, pgt=3, nd=nd)
    out2.pot = out2.pottarg
    out2.grad = out2.gradtarg
    out2.hess = out2.hesstarg
    ...
    out2 = fmm.l3ddir(sources=sources, targets=stmp, dipvec=dipvec, pgt=3, nd=nd)
    out2.pot = out2.pottarg
    out2.grad = out2.gradtarg
    out2.hess = out2.hesstarg
    err = fmm.comperr(ntest=ntest, out=out, outex=out2, pg=3, nd=nd)
    ...
    itest = itest + 1
    out = fmm.lfmm3d(
        eps=eps, sources=sources, charges=charges, dipvec=dipvec, pg=3, nd=nd
    )
    out2 = fmm.l3ddir(
        sources=sources, targets=stmp, charges=charges, dipvec=dipvec, pgt=3, nd=nd
    )
    out2.pot = out2.pottarg
    out2.grad = out2.gradtarg
    out2.hess = out2.hesstarg
    ...
    itest = itest + 1
    out = fmm.lfmm3d(
        eps=eps, sources=sources, targets=targ, charges=charges, pgt=1, nd=nd
    )
    ...
    out = fmm.lfmm3d(
        eps=eps, sources=sources, targets=targ, dipvec=dipvec, pgt=1, nd=nd
    )

    out2 = fmm.l3ddir(sources=sources, targets=ttmp, dipvec=dipvec, pgt=1, nd=nd)
    err = fmm.comperr(ntest=ntest, out=out, outex=out2, pgt=1, nd=nd)
    ...
    out2 = fmm.l3ddir(
        sources=sources, targets=ttmp, charges=charges, dipvec=dipvec, pgt=1, nd=nd
    )
    err = fmm.comperr(ntest=ntest, out=out, outex=out2, pgt=1, nd=nd)
    ...
    itest = itest + 1
    out = fmm.lfmm3d(
        eps=eps, sources=sources, targets=targ, charges=charges, pgt=2, nd=nd
    )
    ...
    out = fmm.lfmm3d(
        eps=eps, sources=sources, targets=targ, dipvec=dipvec, pgt=2, nd=nd
    )
    out2 = fmm.l3ddir(sources=sources, targets=ttmp, dipvec=dipvec, pgt=2, nd=nd)
    err = fmm.comperr(ntest=ntest, out=out, outex=out2, pgt=2, nd=nd)
    ...
    out2 = fmm.l3ddir(
        sources=sources, targets=ttmp, charges=charges, dipvec=dipvec, pgt=2, nd=nd
    )
    err = fmm.comperr(ntest=ntest, out=out, outex=out2, pgt=2, nd=nd)
    ...
    itest = itest + 1
    out = fmm.lfmm3d(
        eps=eps, sources=sources, targets=targ, charges=charges, pgt=3, nd=nd
    )
    ...
    out = fmm.lfmm3d(
        eps=eps, sources=sources, targets=targ, dipvec=dipvec, pgt=3, nd=nd
    )
    out2 = fmm.l3ddir(sources=sources, targets=ttmp, dipvec=dipvec, pgt=3, nd=nd)
    err = fmm.comperr(ntest=ntest, out=out, outex=out2, pgt=3, nd=nd)
    ...
    out2 = fmm.l3ddir(
        sources=sources, targets=ttmp, charges=charges, dipvec=dipvec, pgt=3, nd=nd
    )
    err = fmm.comperr(ntest=ntest, out=out, outex=out2, pgt=3, nd=nd)
    ...
    itest = itest + 1
    out = fmm.lfmm3d(
        eps=eps, sources=sources, targets=targ, charges=charges, pgt=1, pg=1, nd=nd
    )
    out2 = fmm.l3ddir(sources=sources, targets=stmp, charges=charges, pgt=1, nd=nd)
    outex.pot = out2.pottarg
    outex.grad = out2.gradtarg
    ...
    out = fmm.lfmm3d(
        eps=eps, sources=sources, targets=targ, dipvec=dipvec, pgt=1, pg=1, nd=nd
    )
    out2 = fmm.l3ddir(sources=sources, targets=stmp, dipvec=dipvec, pgt=1, nd=nd)
    outex.pot = out2.pottarg
    outex.grad = out2.gradtarg
    ...
    itest = itest + 1
    out = fmm.lfmm3d(
        eps=eps, sources=sources, targets=targ, charges=charges, pgt=2, pg=2, nd=nd
    )
    out2 = fmm.l3ddir(sources=sources, targets=stmp, charges=charges, pgt=2, nd=nd)
    outex.pot = out2.pottarg
    outex.grad = out2.gradtarg
    ...
    out = fmm.lfmm3d(
        eps=eps, sources=sources, targets=targ, dipvec=dipvec, pgt=2, pg=2, nd=nd
    )
    out2 = fmm.l3ddir(sources=sources, targets=stmp, dipvec=dipvec, pgt=2, nd=nd)
    outex.pot = out2.pottarg
    outex.grad = out2.gradtarg
    ...
    itest = itest + 1
    out = fmm.lfmm3d(
        eps=eps, sources=sources, targets=targ, charges=charges, pgt=3, pg=3, nd=nd
    )
    out2 = fmm.l3ddir(sources=sources, targets=stmp, charges=charges, pgt=3, nd=nd)
    outex.pot = out2.pottarg
    outex.grad = out2.gradtarg
    ...
    out = fmm.lfmm3d(
        eps=eps, sources=sources, targets=targ, dipvec=dipvec, pgt=3, pg=3, nd=nd
    )
    out2 = fmm.l3ddir(sources=sources, targets=stmp, dipvec=dipvec, pgt=3, nd=nd)
    outex.pot = out2.pottarg
    outex.grad = out2.gradtarg
